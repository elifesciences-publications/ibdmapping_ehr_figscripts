...
manhattan <- function(x, chr="CHR", bp="BP", p="P", snp="SNP", 
    ...
    par(xpd = FALSE)}
png("PR_Recessive_Manhattan_Plot.png",height=600,width=1000)
manhattan(x,col=c("indianred1","indianred3"),suggestiveline=FALSE,cex=2.5,cex.axis=1.5,cex.lab=1.5,ylab="",ylim=c(-0.5,14))
